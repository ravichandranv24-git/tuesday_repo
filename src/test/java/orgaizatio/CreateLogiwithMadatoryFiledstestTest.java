...
public class CreateLogiwithMadatoryFiledstestTest extends BaseClass{
	@Test(groups = "regioalRegration", retryAnalyzer = GeericLiraries.RetryAnalyzer.class)
...
//			driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
			...
			Assert.assertTrue(actuall.contains(Org));

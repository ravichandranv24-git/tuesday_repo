...
import GeericLiraries.ListerImplemetatioClass;
...
//@Listeners(GeericLiraries.ListernersImplementationClass2.class)
...
//					}
					 ListerImplemetatioClass.extent.get().log(Status.PASS,"");
